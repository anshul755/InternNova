...
from app.features.shortlist.schemas import JobContext, ShortlistDecision
...
async def _decide(state: ShortlistState) -> dict:
    ...
    messages = [
        ...
        HumanMessage(content=USER_PROMPT_TEMPLATE.format(job=job_text, resume=resume_text)),
    ]
